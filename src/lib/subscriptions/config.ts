...
export const subscriptionConfig = {
  ...
  freeEbookUploadsMonthly: Math.max(0, integer("FREE_MONTHLY_EBOOK_UPLOADS", 3)),
  plusEbookUploadsMonthly: Math.max(0, integer("PLUS_MONTHLY_EBOOK_UPLOADS", 20)),
...
export function publicSubscriptionConfig() {
  return {
    ...
    freeEbookUploadsMonthly: subscriptionConfig.freeEbookUploadsMonthly,
    plusEbookUploadsMonthly: subscriptionConfig.plusEbookUploadsMonthly,
    freeMockExamGenerationsMonthly: subscriptionConfig.freeMockExamGenerationsMonthly,
    plusMockExamGenerationsMonthly: subscriptionConfig.plusMockExamGenerationsMonthly,
