...
export function FreeAdSlot({ entitlement, label }: { entitlement: ScholarEntitlement; label: string }) {
  ...
  return (
    <aside aria-label={`${label} sponsor message`} className="scholar-free-ad-slot mx-auto mb-4 flex max-w-3xl items-center justify-between gap-4 rounded-2xl border border-white/10 bg-white/[0.045] px-4 py-3 text-white/70 backdrop-blur-xl">
